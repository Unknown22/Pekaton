...
public class NewTaskState extends BasicGameState {
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
		...
		g.drawString("Do�wiadczenie", margin+cellMargin+cellWidth*2, 150);
		...
		g.setColor(Color.blue);
		g.drawString("Zadania do wzi�cia: ("+(i+1)+"/"+zadania.size()+")", Window.width/2-margin, 250);
		...
		if(zadania.isEmpty()==false)
		{
			...
			if(takenTaskId[i]==1)
				g.drawString("Zadanie wzi�te", margin+cellMargin, 400);
			else
